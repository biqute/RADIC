...
int write_data_24(const char *filename, long long *data, int size)
{
    ...
    printf("\nNumber of data written to file: %d\n", written);
...
//***************** Set the parameters and the board **********************//
    ...
    int err;
    int rc, dir = 0;
    char *device = "plughw:CARD=sndrpihifiberry,DEV=0";  // Name of the device
    ...
    */
   // CHECK THIS STATEMENT BECAUSE SOMEWHERE THERE IS SOMETHING STRANGE
